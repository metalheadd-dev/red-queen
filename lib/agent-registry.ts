...
export const RED_QUEEN_AGENT_DESCRIPTION =
  "RED QUEEN is an agentic survival intelligence system on Solana, developed and operated by SOLvival Corp. She synthesizes verified public, purchased geospatial, emergency, environmental, cyber, and on-chain evidence; explains relevance, provenance, and uncertainty; and converts findings into location-aware briefs, preparedness protocols, wallet-risk analysis, and threat-specific survival carts. Users and agents can approve paid intelligence operations in USDC through x402. For available agent-market inventory, RED QUEEN can prepare a delivery quote and complete a PYUSD x402 physical order only after the owner separately approves address disclosure and the exact wallet payment. She never holds user assets, signs on their behalf, or spends autonomously.";
