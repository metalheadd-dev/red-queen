...
export const REALISTIC: Threat[] = [
  ...
  { id: "CLIMATE-CAT", name: "Climate Catastrophe", level: 74, origin: "Anthropogenic", classification: "ENVIRONMENTAL", status: "HIGH", symptoms: ["Extreme weather events weekly", "Coastal city flooding", "Mass species extinction"], survival: ["Move to higher elevation now", "Water-independent food systems", "Extreme weather shelter prep"], classified: "Internal IPCC models show 4°C warming by 2060. The models were classified to prevent panic.", redactedLabel: "CLASSIFIED: INTERNAL CLIMATE MODELS" },
  ...
  { id: "AI-DISINFO", name: "AI-Driven Disinformation", level: 88, origin: "State-Sponsored / Algorithmic", classification: "COGNITIVE WARFARE", status: "SEVERE", symptoms: ["Hyper-realistic deepfake proliferation", "Algorithmic echo chamber acceleration", "Institutional trust collapse", "Democratic process erosion"], survival: ["Cross-verify all media across 3+ independent sources", "Develop deepfake detection literacy", "Consume primary sources over aggregated feeds", "Maintain analog information channels"], classified: "Nation-state operators are deploying autonomous disinformation agents capable of generating 10,000 tailored narratives per hour. Legacy fact-checking systems are already overwhelmed.", redactedLabel: "CLASSIFIED: ADVERSARIAL NARRATIVE OPERATIONS DATABASE" },
...
export const ALGORITHMIC: Threat[] = [
  {
    id: "WALLET-TRAIL",
    name: "Wallet-Trail: Chain-Surveillance Footprint",
    level: 94,
    origin: "On-Chain Transaction Loggers",
    classification: "SURVEILLANCE VECTOR",
    status: "CRITICAL",
    symptoms: ["Public address correlation", "De-anonymized transaction patterns", "Address clustering heuristics"],
    survival: ["Use privacy wrappers", "Decentralize transaction endpoints", "Rotate recipient addresses"],
    classified: "Autonomous crawler networks scan mainnets in real-time to map user wallets to their IP and geo-location profiles, deanonymizing on-chain activities.",
    redactedLabel: "CLASSIFIED: TRANSACTION ANONYMITY DECRYPT"
  },
  {
    id: "AI-PROFILING",
    name: "AI-Profiling: Cognitive Harvesting",
    level: 91,
    origin: "LLM Scraping Scanners",
    classification: "COGNITIVE PROFILER",
    status: "SEVERE",
    symptoms: ["Synthetic persona harvesting", "Sentiment tracking correlations", "Automated web profiling logs"],
    survival: ["Inject adversarial prompt noise", "Adopt fake metadata footprints", "Minimize public semantic text"],
    classified: "Central LLM aggregators scrape public forums, code repositories, and chats to compile dynamic personality dossiers on your cryptographic key.",
    redactedLabel: "CLASSIFIED: PERSONA SCRAPING LOGS"
  },
  {
    id: "FEED-MANIP",
    name: "Feed-Manip: Sentiment Steering",
    level: 89,
    origin: "Algorithmic Timelines",
    classification: "ATTENTION VECTOR",
    status: "SEVERE",
    symptoms: ["Engineered cognitive loops", "Forced outrage patterns", "Artificially boosted controversy metrics"],
    survival: ["Disable algorithmic feeds", "Use RSS feeds", "Opt out of automated content personalization"],
    classified: "Targeted feed optimization algorithms selectively boost polarizing nodes to keep you emotionally reactive and compliant.",
    redactedLabel: "CLASSIFIED: SENTIMENT ANALYSIS SPECS"
  },
  {
    id: "DEEPFAKE-SE",
    name: "Deepfake-SE: Vocal Clones",
    level: 86,
    origin: "Synthesized Voice & Video",
    classification: "SOCIAL ENGINEERING",
    status: "SEVERE",
    symptoms: ["Simulated vocal authentication overrides", "Artificial executive requests", "Impersonation cascades"],
    survival: ["Establish out-of-band pre-shared keys", "Adopt cryptographic authorization codes", "Verify identity using offline metrics"],
    classified: "Automated synthetic agents can clone human voices from 3-second audio samples to spoof verbal key confirmation channels.",
    redactedLabel: "CLASSIFIED: IMPERSONATION BLUEPRINTS"
  },
  {
    id: "REPUTATION-X",
    name: "Reputation-X: Web3 Blacklist Flags",
    level: 82,
    origin: "Compliance Databases",
    classification: "BLACKLIST HEURISTIC",
    status: "HIGH",
    symptoms: ["DEX swap blockages", "Gated dApp access denials", "Automated AML flag propagation"],
    survival: ["Audit transaction histories", "Avoid contaminated smart contracts", "Utilize clean gas wallets"],
    classified: "Heuristic blacklist engines tag wallets interacting with smart contracts deemed uncompliant, freezing access across standard APIs.",
    redactedLabel: "CLASSIFIED: COMPLIANCE BLACKLIST"
  },
  {
    id: "META-LEAK",
    name: "Meta-Leak: Web2 mapping",
    level: 80,
    origin: "Data Broker Breaches",
    classification: "METADATA CORRELATOR",
    status: "HIGH",
    symptoms: ["Public Web2 emails matched to keys", "Social handle linking via OAuth history", "Cross-platform tracker cookies"],
