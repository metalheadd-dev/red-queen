...
const RANKS = [
  ...
  },
  {
    ...
    color: "#777",
    features: ["Full Terminal chat access", "BIO-SCORE assessment", "Basic survival product links", "Partial Archives access"],
  },
  {
    level: 3,
    name: "OPERATIVE",
  ...
  },
  {
    ...
    color: "#ff884d",
    features: ["All Level 3 features", "Full Archives access", "Classified survival routes", "Direct Red Queen briefings"],
  },
  {
    level: 5,
    name: "DIRECTOR",
