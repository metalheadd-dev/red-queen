  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", paddingTop: "80px", background: "#030303", color: "#fff" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(255, 77, 77, 0.1)", padding: "40px 24px", background: "linear-gradient(180deg, rgba(255, 77, 77, 0.03) 0%, rgba(5,5,5,0) 100%)" }}>
        <div className="container" style={{ maxWidth: "1200px", margin: "0 auto", textAlign: "center" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "10px", padding: "6px 14px", border: "1px solid rgba(255, 77, 77, 0.3)", borderRadius: "30px", background: "rgba(255, 77, 77, 0.05)", marginBottom: "16px" }}>
            ...
            <span style={{ fontSize: "11px", fontFamily: "var(--mono)", letterSpacing: "0.15em", color: "var(--accent)" }}>COMMUNITY MISSIONS</span>
          </div>
          ...
          <p style={{ fontSize: "14.5px", color: "var(--text-dim)", maxWidth: "650px", margin: "0 auto 8px", lineHeight: "1.7", fontFamily: "var(--sans)" }}>
            Welcome to the front lines. Earn XP, elevate your Clearance, and secure SOL bounty payouts. The Red Queen rewards discipline, speed, and absolute survival alignment.
          </p>
      ...
      <div className="container" style={{ flex: 1, maxWidth: "1200px", margin: "0 auto", padding: "40px 24px w-full" }}>
        {/* Toggle between Tasks and Bounties */}
        <div style={{ display: "flex", justifyContent: "center", gap: "16px", marginBottom: "32px" }}>
          <button
            ...
            style={{
              ...
              borderRadius: "4px",
              transition: "all 0.2s",
              boxShadow: activeTab === "tasks" ? "0 0 15px rgba(255, 77, 77, 0.15)" : "none"
            }}
          >
            [ TASKS BOARD ]
          </button>
          <button
            ...
            style={{
              ...
              borderRadius: "4px",
              transition: "all 0.2s",
              boxShadow: activeTab === "bounties" ? "0 0 15px rgba(240, 201, 41, 0.15)" : "none"
            }}
          >
            [ SOL BOUNTIES ]
          </button>
