      ...
      <div className="container onchain-main">
        ...
        <section className="onchain-stack">
          ...
          <div className="onchain-stack-grid">
            ...
            <article className="is-live"><span>LIVE</span><strong>8004 Agent Registry · ID 1474</strong><p>The RED QUEEN Agent Asset is registered on Solana mainnet with public metadata, MCP tools, OASF capabilities and x402 support. Operational-wallet binding remains owner-controlled.</p></article>
