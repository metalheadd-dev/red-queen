...
export default function ActionHistoryPanel() {
  ...
  return (
    <section className="action-history-panel">
      ...
      <Link href="/red-queen?mode=PREPARE&focus=HOUSEHOLD&prompt=Review%20my%20preparedness%20progress%20and%20give%20me%20one%20new%20high-impact%20action.">ASK RED QUEEN FOR THE NEXT ACTION →</Link>
    </section>
  );
}
